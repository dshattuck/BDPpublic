...
if verbose
   ...
   flags = {...
      ...
      '\n',...
      '--odf\n',...
      ['\tSame as using both --FRT and --FRACT flags. Estimates ODFs using both FRT and FRACT.\n'],...
      '\n',...
      '--odf-lambda <L>\n',...
      ...
      'also acceptable). When this flag is '...
      'not used, BDP will generate a pseudo mask using first b=0 image volume and would save it as '...
      '<fileprefix>.dwi.RSA.mask.nii.gz. In case co-registration is not accurate with automatically generated '...
      'pseudo mask, BDP should be re-run with a refined diffusion mask. The mask can be '...
      'generated and/or edited in BrainSuite.\n'],...
      '\n',...
